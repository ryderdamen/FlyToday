...
def test_can_get_visibility():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_visibility(dictionary, 'Test Airport')
...
def test_can_get_wind_information():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_wind_information(dictionary, 'Test Airport')
...
def test_can_get_temperature():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_temperature(dictionary, 'Test Airport')
...
def test_get_altimiter():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_altimeter(dictionary, 'Test Airport')
...
def test_get_elevation():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_elevation(dictionary, 'Test Airport')
...
def test_can_get_metar_raw():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_metar_raw(dictionary, 'Test Airport')
...
def test_get_flight_categories():
    ...
    metar = open(os.path.join(get_data_directory(), 'metar.txt'),'r').read()
    dictionary = helpers.parse_metar_to_dict(BeautifulSoup(metar, features='html.parser'))
    speech, text = weather.get_flight_category(dictionary, 'Test Airport')
